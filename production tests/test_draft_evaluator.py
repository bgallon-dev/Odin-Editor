...
class TestLineDelta:
    ...
    def test_slightly_longer_draft_scores_high(self, evaluator):
        # Draft adds a few lines — should still score well
        score = evaluator.score(SIMPLE_DRAFT_GOOD, SIMPLE_ACCEPTED)
        # SIMPLE_DRAFT_GOOD is ~2 lines longer than SIMPLE_ACCEPTED
        assert score.line_delta >= 0.6
